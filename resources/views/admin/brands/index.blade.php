        ...
        <div class="col-xs-12">
            <div class="box box-danger">
                <div class="box-header" >
                    <h3 class="box-title" style="width: 100%">Our Brands
              </button>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    if($user['status'] == '0'){
                    @endphp
                      <a style="float: left;margin-right: 10px;" title="Approve" class="btn btn-primary" onclick="return confirm('Are you sure you want to Approve this brand?')" href="approve/{{$user['id']}}"><span class="glyphicon glyphicon-ok"></span></a>
                    @php
                    }else{
                    @endphp
                    ...
                    <a style="float: left;margin-right: 10px;" title="Delete" class="btn btn-primary" onclick="return confirm('Are you sure you want to delete this brand?')" href="delete/{{$user['id']}}"><span class="glyphicon glyphicon-trash"></span></a>
