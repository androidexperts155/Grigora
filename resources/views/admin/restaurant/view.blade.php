...
//echo'<pre>';print_r($order);die;
                ...
                ?>
                  ...
                  @endphp
                  <tr style="height: 50px;">
                    <td style="width: 200px;">Franchisee Proof</td>
                    <td><a href="{{$users->franchisee_proof}}" target="__blank"><img src="{{$users->franchisee_proof}}" style="height: 100px;width: 100px;"></a></td>
                  </tr>
                  @php
                  }
                  @endphp
                  ...
                  <tr style="height: 50px;">
                    <td style="width: 200px;">Cuisins</td>
                    <td>{{$users->cuisins}}</td>
                  </tr>

                  <tr style="height: 50px;">
                    <td style="width: 200px;">Average Rating</td>
                    <td>{{$users->average_rating}}</td>
                  </tr>
