        ...
        <div class="col-xs-12">
            <div class="box box-danger">
                <div class="box-header">
                    <h3 class="box-title">Add Restaurant
                    </h3>
                      ...
                      @endif
                    <form id="model-form" role="form" action="{{url('restaurant/save')}}" enctype="multipart/form-data" method="POST">
                    <div class="box-body">
                    {{csrf_field()}}
                              ...
                              <tr>
                                 ...
                                 <td> <input type="text" placeholder="Email" value="" class="form-control" name="email" required></td>
                              </tr>
                              ...
                              <tr>
                                 ...
                                 <td> <input type="password" placeholder="Password" value="" class="form-control" name="password" required></td>
                              </tr>
                              ...
                              <tr>
                                 ...
                                 <td> <input type="text" placeholder="Phone Number" value="" class="form-control" name="phone" onkeypress="javascript:return isNumber(event)" required></td>
                              </tr>  
                              <tr><td><br/></td></tr>
                              <tr>
                             <br/>
                         ...
                         <!--      <tr>
                                <td><br/><b>Cuisines</b></td>
                              </tr>
                              <tr>
                                <td> 
                                @foreach($cusines as $cusineId => $cusineName)
                                  <input type="checkbox" name="cusines[]" value="{{$cusineId}}">&nbsp;&nbsp;{{$cusineName}}
                                @endforeach
                                </td>
                              </tr> -->
