        ...
        <div class="col-xs-12">
            <div class="box box-danger">
                <div class="box-header">
                    <h3 class="box-title">Paid Page Notifications
                    </h3>
                      ...
                      @endif
                    <form id="model-form" role="form" action="{{route('send_paidpagenotifications')}}" enctype="multipart/form-data" method="POST">
                    <div class="box-body">
                    {{csrf_field()}}
