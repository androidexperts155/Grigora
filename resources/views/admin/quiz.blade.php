...
" onsubmit="return send_msg();" enctype="multipart/form-data" method="POST">
                    ...
                    {{csrf_field()}}
                              ...
                              <tr>
                                <td><input type="text" name="question" class="form-control" value="{{$quiz['question']}}" required></td>
                              </tr>
                              ...
                              <tr>
                                <td></br><b>Offer Percentage</b></td>
                              </tr>
                              <tr>
                                <td><input type="text" name="offer_percentage" class="form-control"  value="{{$quiz['offer_percentage']}}" onkeypress="javascript:return isNumber(event)" required></td>
                              </tr>
                              ...
                              <tr>
                                <td><input type="text" name="min_order_value" value="{{$quiz['min_order_value']}}" class="form-control"  onkeypress="javascript:return isNumber(event)" required></td>
                              </tr>
